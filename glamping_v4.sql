...
INSERT INTO `camp_type` (`id`, `type`, `capacity`, `price`, `weekend_rate`, `holiday_rate`, `updated_at`, `id_camp_site`)
VALUES
    (1, 'Tent', 4, 100.00, 120.00, 150.00, NOW(), 1),
    (2, 'Glamping', 2, 250.00, 280.00, 320.00, NOW(), 2),
    (3, 'Eco-Cabin', 3, 180.00, 200.00, 240.00, NOW(), 3),
    (4, 'RV', 6, 120.00, 150.00, 180.00, NOW(), 4),
    (5, 'Safari Tent', 5, 220.00, 250.00, 300.00, NOW(), 5);

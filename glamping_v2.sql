...
CREATE TABLE `booking` (
  ...
  `created_at` datetime,
  `status` enum("Pending", "Deposit", "Accepted", "Paid" ,"Check_In", "Check_Out", "Completed", "Cancelled", "Denied", "Refund"),
...
ALTER TABLE `booking_detail_service` ADD FOREIGN KEY (`id_booking_detail`) REFERENCES `booking_detail` (`id`);

ALTER TABLE `booking_detail_service` ADD FOREIGN KEY (`id_service`) REFERENCES `service` (`id`);

ALTER TABLE `camp_facility` ADD FOREIGN KEY (`id_camp`) REFERENCES `camp` (`id`);

ALTER TABLE `camp_facility` ADD FOREIGN KEY (`id_facility`) REFERENCES `facility` (`id`);
...
ALTER TABLE `booking_detail` ADD FOREIGN KEY (`id_camp`) REFERENCES `camp` (`id`);
...
INSERT INTO `facility` (`id`, `name`, `description`, `status`)
VALUES
(1, 'WiFi', 'High-speed internet access', true),
(2, 'Hot Tub', 'Relaxing hot water pool', true),
(3, 'Outdoor Grill', 'BBQ facilities', true),
(4, 'Sauna', 'Indoor sauna for relaxation', true);

-- Insert Data into `camp_facility` Table
INSERT INTO `camp_facility` (`id_facility`, `id_camp`, `status`)
VALUES
(1, 1, true), (2, 1, true), (3, 1, true),  -- Tent Camp 1
(1, 2, true), (2, 2, true), (4, 2, true),  -- Tent Camp 2
(1, 3, true), (3, 3, true);  -- Tent Camp 3
...
INSERT INTO `utility` (`id`, `name`, `status`)
VALUES
(1, 'Electricity', true),
(2, 'Water', true),
(3, 'Waste Disposal', true);

-- Insert Data into `camp_site_utility` Table
INSERT INTO `camp_site_utility` (`id_camp_site`, `id_utility`, `status`)
VALUES
(1, 1, true), (1, 2, true), (1, 3, true),  -- Mountain Base Camp
(2, 1, true), (2, 2, true), (2, 3, true);  -- Lake Side Glamping
...
AND (
    (DATE(bd.check_in_at) < '2025-01-19' AND DATE(bd.check_out_at) > '2025-01-18')
)
WHERE ct.id = 1
AND (bd.id IS NULL)
ORDER BY c.id;

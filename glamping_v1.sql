...
ALTER TABLE `feedbacks` ADD FOREIGN KEY (`id_user`) REFERENCES `user` (`id`);

ALTER TABLE `booking` ADD FOREIGN KEY (`id_user`) REFERENCES `user` (`id`);

ALTER TABLE `camp_area` ADD FOREIGN KEY (`id_user`) REFERENCES `user` (`id`);

ALTER TABLE `camp` ADD FOREIGN KEY (`id_camp_area`) REFERENCES `camp_area` (`id`);
...
ALTER TABLE `camp_option` ADD FOREIGN KEY (`id_camp`) REFERENCES `camp` (`id`);

ALTER TABLE `camp_option` ADD FOREIGN KEY (`id_option`) REFERENCES `option` (`id`);

ALTER TABLE `image` ADD FOREIGN KEY (`id_camp_area`) REFERENCES `camp_area` (`id`);

ALTER TABLE `report` ADD FOREIGN KEY (`id_camp_area`) REFERENCES `camp_area` (`id`);

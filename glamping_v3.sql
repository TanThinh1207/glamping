...
(
    ...
    name `              varchar(255), `
    quantity `          decimal,
    PRIMARY KEY (` id_booking_detail `, ` id_service `)
);
...
(
    ...
    id_camp `     integer, `
    status `      boolean default (true),
    PRIMARY KEY (` id_facility `, ` id_camp `)
);
...
INSERT INTO ` camp_site ` (` id `, ` name `, ` address `, ` latitude `, ` longitude `, ` created_at `, ` quantity `, `
                             status `, ` id_user `)
VALUES (1, 'Mountain Base Camp', '123 Mountain Rd', 35.2431, 78.1234, NOW(), 3, 'Available', 1),
...
INSERT INTO ` camp_type ` (` id `, ` type `, ` capacity `, ` price `, ` weekend_rate `, ` holiday_rate `, `
                             updated_at `, ` id_camp_site `, ` quantity `)
VALUES (1, 'Tent', 4, 100.00, 120.00, 150.00, NOW(), 1, 3),
...
-- For "Tent" (quantity = 3)
INSERT INTO ` camp ` (` id `, ` name `, ` description `, ` created_at `, ` status `, ` capacity `, ` price `, `
                        updated_at `, ` view `, ` id_camp_type `)
VALUES (1, 'Tent Camp 1', 'A basic tent camp with stunning views.', NOW(), 1, 4, 100.00, NOW(), 'Mountain View', 1),
...
INSERT INTO ` camp ` (` id `, ` name `, ` description `, ` created_at `, ` status `, ` capacity `, ` price `, `
                        updated_at `, ` view `, ` id_camp_type `)
VALUES (4, 'Glamping Tent 1', 'Fully furnished glamping tents with AC.', NOW(), 1, 2, 250.00, NOW(), 'Lake View', 2),
       (5, 'Glamping Tent 2', 'Fully furnished glamping tents with AC.', NOW(), 1, 2, 250.00, NOW(), 'Lake View', 2);

-- For "Eco-Cabin" (quantity = 1)
INSERT INTO ` camp ` (` id `, ` name `, ` description `, ` created_at `, ` status `, ` capacity `, ` price `, `
                        updated_at `, ` view `, ` id_camp_type `)
VALUES (6, 'Eco-Cabin 1', 'A small eco-friendly cabin with all amenities.', NOW(), 1, 3, 180.00, NOW(), 'Forest View',
        3);

-- For "RV" (quantity = 2)
INSERT INTO ` camp ` (` id `, ` name `, ` description `, ` created_at `, ` status `, ` capacity `, ` price `, `
                        updated_at `, ` view `, ` id_camp_type `)
VALUES (7, 'RV Park 1', 'Spacious RV parking with utilities.', NOW(), 1, 6, 120.00, NOW(), 'Desert View', 4),
       (8, 'RV Park 2', 'Spacious RV parking with utilities.', NOW(), 1, 6, 120.00, NOW(), 'Desert View', 4);

-- For "Safari Tent" (quantity = 1)
INSERT INTO ` camp ` (` id `, ` name `, ` description `, ` created_at `, ` status `, ` capacity `, ` price `, `
                        updated_at `, ` view `, ` id_camp_type `)
VALUES (9, 'Safari Tent 1', 'A large tent with safari-style furnishings.', NOW(), 1, 5, 220.00, NOW(), 'Savanna View',
        5);

-- Insert Data into `booking` Table
INSERT INTO ` booking ` (` id `, ` id_user `, ` id_camp_site `, ` created_at `, ` status `, ` total_amount `)
VALUES (1, 3, 1, NOW(), 'Paid', 300.00),
...
-- Insert Data into `camp_facility` Table
INSERT INTO ` camp_facility ` (` id_facility `, ` id_camp `)
VALUES (1, 1),
       (2, 1),
       (3, 1),
       (4, 1),
...
INSERT INTO `booking_detail` (`id`, `id_booking`, `id_camp`, `check_in_at`, `check_out_at`, `amount`, `comment`, `rating`, `created_at`, `add_on`)
VALUES
(1, 1, 1, NOW(), NOW() + INTERVAL 2 DAY, 300.00, 'Great stay!', 5, NOW(), 0.00),
(2, 2, 2, NOW(), NOW() + INTERVAL 3 DAY, 500.00, 'Loved the tent but could have used more lighting.', 4, NOW(), 0.00);

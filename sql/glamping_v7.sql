...
INSERT INTO ` camp_site ` (` id `, ` name `, ` address `, ` latitude `, ` longitude `, ` created_at `, ` status `, `
                             id_user `)
VALUES (1, 'Mountain Base Camp', '123 Mountain Rd', 35.2431, 78.1234, NOW(), 'Available', 1),
...
with charcoal, utensils, and seating for a great outdoor meal.', 30.00, 'bbq.jpg', TRUE, NOW()),
...
with firewood, seating, and marshmallows.', 20.00, 'bonfire.jpg', TRUE, NOW()),
